    ...
    attach: function (context, settings) {
      function setPumpkins() {
        ...
        for (let i = 1; i < 26; i++) {
          ...
          if (glowPumpkin) {
            // Create a pumpkin without a black background but with the orange glow
            const pumpkin = $('<div class="pumpkin"><svg class="pumpkin__item pump_' + i + '" viewBox="0 0 64 64">' +
            ...
            setInterval(function () {
              pumpkin.find('.glow').toggleClass('glow-on');
            }, Math.random() * 3000 + 750);
          } else {
            // Create a regular pumpkin with a black background
            wrapper.append('<div class="pumpkin"><svg class="pumpkin__item pump_' + i + '" viewBox="0 0 64 64">' +
